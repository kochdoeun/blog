			...
			<form class="col s12">
				<div class="row">
					<div class="input-field col s12">
						<input placeholder="This user name will use for login" id="loginname" type="text"
						       class="validate">
				...
				<div class="row">
					<div class="input-field col s12">
						<p>Don't have an account? <a class="red-text" href="register1.html">Sign up now, It's FREE!</a>
						</p>
					</div>
				</div>
			</form>
