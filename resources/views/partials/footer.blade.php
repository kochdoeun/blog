      ...
      <div class="row">
        ...
        <div class="col l3 s12">
          ...
          <ul>
            ...
            <li><a class="white-text" href="#!">Our Vision</a></li>
            <li><a class="white-text" href="#!">Our Mission</a></li>
          </ul>
        </div>
        <div class="col l3 s12">
          ...
          <ul>
            ...
            <li><a class="white-text" href="#!">Yourtube</a></li>
            <li><a class="white-text" href="#!">Link-in</a></li>
